    ...
    <>
      <header
        className={`header top-0 left-0 z-40 flex w-full items-center bg-transparent ${
          sticky
            ? "!fixed !z-[9999] !bg-white !bg-opacity-80 shadow-sticky backdrop-blur-sm !transition dark:!bg-[#facc15] dark:!bg-opacity-20"
            : "absolute"
        }`}
      >
            ...
            <div className="flex w-full items-center justify-between px-4">
              <div>
                <button
                  ...
                  className="absolute right-4 top-1/2 block translate-y-[-50%] rounded-lg px-3 py-[6px] ring-[#facc15] focus:ring-2 lg:hidden"
                >
                  <span
              ...
              <div className="flex items-center justify-end pr-16 lg:pr-0">
                ...
                <Link
                  href="/contact"
                  className="ease-in-up hidden rounded-md bg-[#facc15] py-3 px-8 text-base font-bold text-white transition duration-300 hover:bg-opacity-90 hover:shadow-signUp md:block md:px-9 lg:px-6 xl:px-9"
                >
                  Get Consultation
                </Link>
                <div>
