...
const Footer = () => {
  return (
    <>
      <footer
        className="wow fadeInUp relative z-10 bg-[#facc15] bg-opacity-5 pt-16 md:pt-20 lg:pt-24"
        data-wow-delay=".1s"
      >
          ...
          <div className="-mx-4 flex flex-wrap">
              ...
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <div className="flex items-center">
                  <a
                    ...
                    className="mr-6 text-[#CED3F6] hover:text-[#facc15]"
                  >
                    <svg
                      width="9"
                      height="18"
              ...
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  <li>
                    <a
                      href="/"
                      className="mb-4 inline-block text-base font-medium text-body-color hover:text-[#facc15]"
                    >
                      {" "}
                      Corporate Advisory{" "}
                    </a>
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-3/12">
              <div className="mb-12 lg:mb-16">
                ...
                <p className="mb-4 inline-block text-base font-medium text-body-color hover:text-[#facc15]">
        ...
        <div className="bg-[#facc15]/10 py-8">
          <div className="container">
            <p className="text-center text-base text-body-color dark:text-white">
              &copy; {new Date().getFullYear()} &nbsp; Extent Corporate Advisory
            </p>
          </div>
        </div>
