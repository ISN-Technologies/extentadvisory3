        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
              ...
              <div>
                ...
                <div className="mb-10 flex flex-wrap items-center justify-between border-b border-body-color border-opacity-10 pb-4 dark:border-white dark:border-opacity-10">
                  ...
                  <div className="mb-5">
                    <a
                      href="#0"
                      className="inline-flex items-center justify-center rounded-full bg-[#facc15] py-2 px-4 text-sm font-semibold text-white"
                    >
                      Design
                    </a>
                  </div>
                ...
                <div>
                  ...
                  <p className="mb-8 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    ...
                    <strong className="text-[#facc15] dark:text-white">
                      {" "}
                      malesuada{" "}
                    </strong>
                  ...
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    ...
                    <span className="text-[#facc15] underline dark:text-white">
                      {" "}
                  ...
                  <div className="relative z-10 mb-10 overflow-hidden rounded-md bg-[#facc15] bg-opacity-10 p-8 md:p-9 lg:p-8 xl:p-9">
            ...
            <div className="w-full px-4 lg:w-4/12">
              <div className="mt-12 mb-10 rounded-md bg-[#facc15] bg-opacity-5 p-6 dark:bg-opacity-5 lg:mt-0">
                <form className="flex items-center justify-between">
                  <input
                    type="text"
                    placeholder="Search here..."
                    className="palceholder-body-color mr-5 w-full rounded-md border border-transparent py-3 px-5 text-base font-medium text-body-color outline-none focus:border-[#facc15] dark:bg-white dark:bg-opacity-10"
                  />
                  <button className="flex h-[50px] w-full max-w-[50px] items-center justify-center rounded-md bg-[#facc15] text-white">
                    <svg
                      width="20"
                      height="18"
                      viewBox="0 0 20 18"
              ...
              <div className="mb-10 rounded-md bg-[#facc15] bg-opacity-5 dark:bg-opacity-10">
              ...
              <div className="mb-10 rounded-md bg-[#facc15] bg-opacity-5 dark:bg-opacity-10">
                ...
                <ul className="py-6 px-8">
                  <li>
                    <a
                      href="#0"
                      className="mb-3 inline-block text-base font-medium text-body-color hover:text-[#facc15]"
                    >
                      Tailwind Templates
                    </a>
                  </li>
