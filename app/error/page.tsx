          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div className="mx-auto max-w-[530px] text-center">
                ...
                <Link
                  href="/"
                  className="rounded-md bg-[#facc15] py-3 px-8 text-base font-bold text-white shadow-signUp duration-300 hover:bg-white hover:text-[#facc15] md:px-9 lg:px-8 xl:px-9"
                >
                  Back to Homepage
                </Link>
              </div>
